class EmailProgram extends Program {
    ...
    let body = `
            <div class="menu-bar__container">
                ...
                <div class="menu-bar__menu">
                    ...
                    <input class="menu-bar__input" type="text" value="thounnykeo@gmail.com" disabled>
                </div>
                <div class="menu-bar__hr"></div>
                <div class="menu-bar__menu">
                    <div class="menu-bar__handle"></div>
  ...
  generateMailto() {
    let subject = this.getBodyHandle().querySelector(
      'input[name="subject"]'
    ).value;

    let cc = this.getBodyHandle().querySelector('input[name="cc"]').value;

    let body = this.getBodyHandle().querySelector("textarea.email__body").value;
    ...
    let href = `mailto:thounnykeo@gmail.com?subject=${subject}&cc=${cc}&body=${body}`;
